...
export function StatsBand() {
  return (
    <section className="border-b border-oro/[0.14] bg-navy-black px-6 py-10 md:px-10">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3">
        {STATS.map((stat) => (
          <div key={stat.label} className="text-center sm:text-left">
            <div className="font-display text-4xl font-bold leading-none text-oro md:text-5xl">
              {stat.value}
            </div>
